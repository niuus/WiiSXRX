...
int StartServer()
{
	DEBUG_vc_printf("%s:%d: TODO: impl StartServer.\n",
			__FILE__, __LINE__);
	return -1;
}
...
void StopServer()
{
	DEBUG_vc_printf("%s:%d: TODO: impl StopServer.\n",
			__FILE__, __LINE__);
}

void GetClient()
{
	DEBUG_vc_printf("%s:%d: TODO: impl GetClient.\n",
			__FILE__, __LINE__);
}

void CloseClient()
{
	DEBUG_vc_printf("%s:%d: TODO: impl CloseClient.\n",
			__FILE__, __LINE__);
}

int HasClient()
{
	DEBUG_vc_printf("%s:%d: TODO: impl HasClient.\n",
			__FILE__, __LINE__);
	return 0;
}
...
int ReadSocket(char * buffer, int len)
{
	DEBUG_vc_printf("%s:%d: TODO: impl ReadSocket.\n",
			__FILE__, __LINE__);
	return -1;
}
...
int RawReadSocket(char * buffer, int len)
{
	DEBUG_vc_printf("%s:%d: TODO: impl RawReadSocket.\n",
			__FILE__, __LINE__);
	return -1;
}
...
void WriteSocket(char * buffer, int len)
{
	DEBUG_vc_printf("%s:%d: TODO: impl WriteSocket.\n",
			__FILE__, __LINE__);
	return -1;
}
...
void SetsBlock()
{
	DEBUG_vc_printf("%s:%d: TODO: impl SetsBlock.\n",
			__FILE__, __LINE__);
}

void SetsNonblock()
{
	DEBUG_vc_printf("%s:%d: TODO: impl SetsNonBlock.\n",
			__FILE__, __LINE__);
}
